# VOLUME VIII — EXPANSION, FINANCIAL ARCHITECTURE & THE 20-YEAR ROADMAP

### The three phases · The three scenarios · Capital · Geography · Acquisitions

*Edition II. Every figure in this volume is an estimate carrying its assumptions inline. Nothing here is a forecast of record, a promise, or a guarantee.*

---

## Contents

1. [THE 20-YEAR MASTER ROADMAP](#chapter-1--the-20-year-master-roadmap)
2. [The Phase Gates](#chapter-2--the-phase-gates)
3. [Unit Economics](#chapter-3--unit-economics)
4. [The Revenue Model](#chapter-4--the-revenue-model)
5. [THE THREE SCENARIOS](#chapter-5--the-three-scenarios)
6. [Valuation Logic, Honestly Stated](#chapter-6--valuation-logic-honestly-stated)
7. [Capital Strategy](#chapter-7--capital-strategy)
8. [Capital Allocation & Investment Framework](#chapter-8--capital-allocation--investment-framework)
9. [International Expansion](#chapter-9--international-expansion)
10. [The Market-Entry Checklist](#chapter-10--the-market-entry-checklist)
11. [Acquisition Strategy](#chapter-11--acquisition-strategy)
12. [Financial Controls & Reporting](#chapter-12--financial-controls--reporting)
13. [What Would Make This Plan Wrong](#chapter-13--what-would-make-this-plan-wrong)
...
| 2 | Net revenue retention | ≥ 105% (Volume V §7.1) |
...
Revenue ≥ the Chapter 5 growth-scenario floor · recurring share ≥ 65% (Volume I §6.2 portfolio rule) · NRR ≥ 115% · operations in ≥ 3 countries with local leadership · ≥ 2 ecosystems beyond education at Volume I §2.4 depth · partner-delivered revenue ≥ 30% · a functioning board with independent directors · audited accounts · Rule of 40 ≥ 30.
...
1. CAC is genuinely low because acquisition is referral- and free-tier-driven rather than paid (Volume V §1.1).
2. Delivery labour is local and Band A pricing is set against local cost, so margin survives the discount.
3. The module ladder produces expansion revenue that partially offsets churn.
...
**Assumptions:** NRR stabilises at ~105% · Nigeria and West Africa only until late Phase II · one modest developed-market entry (UK) that takes longer and costs more than planned · government contracts won but slowly · recurring mix reaches 70% · gross margin 68% by 2040 · profitable from ~2032 · minimal external capital.
**Implied CAGR 2030→2040: ~31%.**
**Indicative valuation at 4–5× revenue: $680M–$850M (2046).**

**Why this is a good outcome.** A profitable, independent, $170M-revenue company employing a thousand people, serving nine thousand institutions across six countries, with a genuinely trusted brand and no external control, is a serious achievement and a fine life's work. Any plan that treats this as failure will make bad decisions to avoid it.
...
Public SaaS median EV/Revenue sat at roughly **8.5× NTM revenue as of mid-2026**, having recovered from a ~4.5× trough in Q1 2023 but remaining well below the ~16× 2021 peak; other measures of the same market put the median EV/TTM materially lower, around 3.3×, and private SaaS medians around **4–5× ARR**. Companies with **NRR above 120% and a Rule of 40 above 50 reach 7–9×** ([ValueAdd VC](https://valueaddvc.com/saas-valuations), [Aventis Advisors](https://aventis-advisors.com/saas-valuation-multiples/), [L40](https://www.l40.com/insights/saas-multiples)). The median Rule of 40 score across actively traded SaaS companies is only **28%, with just 20% exceeding 40** ([Eqvista](https://eqvista.com/saas-index-revenue-multiples-valuations-market-trends/)).

Three consequences the group must internalise:

1. **Multiples are volatile and outside our control.** The same company was worth 16× in 2021 and 4.5× in 2023. Any plan whose success depends on a specific multiple is a plan that depends on the weather. **We control revenue, margin, retention and growth. We do not control the multiple, and we will not manage the company as though we do.**
2. **A mixed-margin group is valued below a pure-SaaS comparable.** Services, print and hardware drag the blended multiple. This is a real and permanent cost of the completeness strategy (Volume II §6, Wedge 2) — and it is a cost worth paying, because completeness is what wins the customers in the first place. But it must be stated rather than wished away.
3. **The premium band is earned by two specific numbers: NRR and Rule of 40.** Everything in Volume V Chapter 7 exists to move the first. Everything in Volume I §6.2's portfolio rule exists to make the second possible.
...
1. **Why is this included?** What does the group get that it does not have?
2. **What measurable value does it create?** In what units, by when?
3. **What risks does it introduce?** Including the risk of distraction.
4. **What assumptions underpin it?** Which one, if wrong, kills it?
5. **How will success be measured?** And who is accountable for measuring it?
...
**Legal & regulatory**
☐ Entity incorporated ☐ Tax registration ☐ Employment compliance reviewed ☐ Data protection regime mapped and implemented ☐ Sector regulator requirements documented ☐ Trademark filed ☐ Contracts localised by local counsel ☐ Sanctions and export-control screening ☐ Anti-corruption exposure assessed (Volume I §6.6)

**Commercial**
☐ Market sized by the Volume II §2.2 method with dated inputs ☐ Price band assigned ☐ Competitors mapped ☐ At least three reference prospects identified ☐ Partner or acquisition target assessed ☐ Payment rails live ☐ Local currency handling ☐ Collection risk assessed

**Product**
☐ Language complete ☐ Curriculum/sector standards mapped ☐ Local integrations built (payments, examination boards, regulators) ☐ Data residency in place if required ☐ Accessibility to local standard ☐ Offline/low-bandwidth verified on local networks

**Operational**
☐ Local leader hired, with authority ☐ Support hours covered ☐ Delivery capacity confirmed in writing ☐ Escalation path defined ☐ Local banking ☐ Insurance ☐ Office or remote model decided

**Financial**
☐ Entry budget approved ☐ Break-even modelled with stated assumptions ☐ FX exposure hedged or accepted explicitly ☐ **Exit criteria defined** — what would make us withdraw, and by when
...
1. **Strategic fit** — it advances a named objective in this corpus, not merely an adjacent opportunity.
2. **Cultural fit** — would we hire these people? Do they share the Volume I §7 ethics? *A team that would not pass our ethics review is not acquirable at any price.*
3. **Integration plan exists** — written before the offer, naming who integrates it and by when.
4. **The team stays** — key people committed, or the acquisition is of assets and priced as such.
5. **Clean diligence** — legal, financial, technical, security, IP ownership, customer contracts, and data-handling practices. **A target that has been selling or mishandling customer data is not acquirable**, regardless of its numbers.
6. **We can afford to be wrong** — no single acquisition may risk the group.
7. **The alternative was considered** — build, partner or buy, compared explicitly. Buying because it is faster is a valid answer only when the comparison was actually made.
...
*Volume VIII ends. Volume IX — [The Institution](VOLUME-IX-THE-INSTITUTION.md).*

*Sources for Chapter 5.4: [ValueAdd VC — SaaS valuation multiples 2026](https://valueaddvc.com/saas-valuations) · [Aventis Advisors — SaaS valuation multiples 2015–2026](https://aventis-advisors.com/saas-valuation-multiples/) · [L40 — SaaS multiples, the real private range](https://www.l40.com/insights/saas-multiples) · [Eqvista — SaaS index: revenue multiples, valuations & market trends](https://eqvista.com/saas-index-revenue-multiples-valuations-market-trends/). Retention benchmarks: Volume V §7.1.*
