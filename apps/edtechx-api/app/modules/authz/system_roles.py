...
SYSTEM_ROLES: tuple[RoleTemplate, ...] = (
    ...
    RoleTemplate(
        ...
        permissions=_p(
            ...
            # Certificates, statements of enrolment, completion letters — the
            # documents that are neither a report card nor a transcript, and
            # that a registrar is the person who issues.
